        ...
        <nav class="navbar navbar-expand-lg py-lg-3 navbar-dark">
            <div class="container">
                ...
                <a href="index.html" class="navbar-brand me-lg-5">
                    <img src="assets/images/plong.png" alt="" class="logo-dark" height="30" width="150">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarNavDropdown">
                    ...
                    <ul class="navbar-nav me-auto align-items-center">
                        ...
                        <li class="nav-item mx-lg-1">
                            <a class="nav-link" href="pages-register-2.php">Apply Now as Borrower</a>
                        </li>
                        <li class="nav-item mx-lg-1">
                            <a class="nav-link" href="pages-register-3.php">Apply Now as Lender</a>
                        </li>
                    ...
                    <ul class="navbar-nav ms-auto align-items-center">
                        <li class="nav-item me-0">
                            <a href="login.php" target="_blank" class="nav-link d-lg-none">Purchase now</a>
                            <a href="login.php" target="_blank" class="btn btn-sm btn-light btn-rounded d-none d-lg-inline-flex">
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-md-5 offset-md-2">
                        <div class="text-md-end mt-3 mt-md-0">
                            <img src="assets/images/plogo.png" alt="" class="img-fluid">
                        </div>
                    </div>
                </div>
            </div>
