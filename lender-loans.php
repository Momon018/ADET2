                                            ...
                                            <table class="table table-centered mb-0">
                                                <thead class="table-light">
                                                    <tr>
                                                        ...
                                                        <th scope="col">Loan_rate</th>
                                                        <th scope="col">Loan_terms</th>
                                                        <th scope="col">Loan_processing_fee</th>
                                                        <th scope="col">Loan_created</th>
                                                            ...
                                                            while ($row = $rs-> fetch_assoc()){
                                                                $ID = $row["LoanID"];
                                                                    ...
                                                                    echo"
                                                                        ...
                                                                        <a href='deleteloans.php?deleteid=".$ID."' class='action-icon'> <i class='mdi mdi-delete'></i></a>
                                                                        </td>
                                                                        </tr>";
