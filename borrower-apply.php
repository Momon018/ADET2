            ...
            <div class="leftside-menu">
                ...
                <div class="h-100" id="leftside-menu-container" data-simplebar="">
                    ...
                    <ul class="side-nav">
                        ...
                        <li class="side-nav-item">
                            <a data-bs-toggle="" href="borrower-home.php" class="side-nav-link">
                                <i class="uil-briefcase-alt"></i>
                                <span> Home </span>
                            </a>

                            <a data-bs-toggle="" href="borrower-apply.php" class="side-nav-link">
                                <i class="uil-calendar-alt"></i>
                                <span> Apply </span>
                            </a>

                            <a data-bs-toggle="" href="borrower-cloan.php" class="side-nav-link">
                                <i class="uil-calendar-alt"></i>
                                <span> Current Loan </span>
                            </a>

                            <a data-bs-toggle="" href="borrower-profile.php" class="side-nav-link">
                                <i class="uil-calendar-alt"></i>
                                <span> Profile </span>
                            </a>
                                            ...
                                            <table class="table table-centered mb-0">
                                                ...
                                                <tbody>
                                                    <?php 
                                                        ...
                                                        $sql = "SELECT * from loan_product WHERE loan_status = 'Active'";
                                                        $rs = $con-> query($sql);
                                                        ...
                                                        if($rs-> num_rows > 0){
                                                            while ($row = $rs-> fetch_assoc()){
                                                                $ID = $row["LoanID"];
                                                                    ...
                                                                    echo"
                                                                        <tr><td>".$row["Loan_product_name"]."</td>
                                                                        <td>".$row["Loan_Description"]."</td>
                                                                        <td>".$row["Loan_amount"]."</td>
                                                                        <td>".$row["Loan_rate"]."</td>
                                                                        <td>".$row["Loan_terms"]."</td>
                                                                        <td>".$row["Loan_processing_fee"]."</td>
                                                                        <td>".$row["Loan_created"]."</td>
                                                                        <td>
 
                                                                        <a href='applyloan.php?applyid=".$ID."'><u><center>Apply for this loan. </center></a></u>
                                                                        </td>
                                                                        </tr>";
