                    ...
                    <div class="card-body">
                        ...
                        <form action="#">
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" id="fullname" placeholder="Enter your first name" required>
                            </div>
                            <div class="mb-3">
                                <label for="fullname" class="form-label">Middle Name</label>
                                <input class="form-control" type="text" id="fullname" placeholder="Enter your middle name" required>
                            </div>
                            <div class="mb-3">
                                <label for="fullname" class="form-label">Last Name</label>
                                <input class="form-control" type="text" id="fullname" placeholder="Enter your last name" required>
                            </div>
                            <div class="mb-3">
                                <label for="fullname" class="form-label">Suffix</label>
                                <input class="form-control" type="text" id="fullname" placeholder="Enter your suffix" required>
                            </div>
                            <div class="mb-3">
                                <label for="fullname" class="form-label">Email Address</label>
                                <input class="form-control" type="text" id="fullname" placeholder="Enter your email address" required>
                            </div>
                            <div class="mb-3">
                                <label for="fullname" class="form-label">Gender</label>
                                <input class="form-control" type="text" id="fullname" placeholder="Enter your gender" required>
                            </div>
                            <div class="mb-3">
                                <label for="fullname" class="form-label">Birthdate</label>
                                <input class="form-control" type="text" id="fullname" placeholder="Enter your birthdate" required>
                            </div>
                            <div class="mb-3">
                                <label for="fullname" class="form-label">Contact Number</label>
                                <input class="form-control" type="text" id="fullname" placeholder="Enter your contact number" required>
                            </div>
                            <div class="mb-3">
                                <label for="fullname" class="form-label">Line 1</label>
                                <input class="form-control" type="text" id="fullname" placeholder="Line 1" required>
                            </div>
                            <div class="mb-3">
                                <label for="fullname" class="form-label">Line 2</label>
                                <input class="form-control" type="text" id="fullname" placeholder="Line 2" required>
                            </div>
                            <div class="mb-3">
                                <label for="fullname" class="form-label">Baranggay</label>
                                <input class="form-control" type="text" id="fullname" placeholder="Enter your baranggay" required>
                            </div>
                            <div class="mb-3">
                                <label for="emailaddress" class="form-label">City/Town</label>
                                <input class="form-control" type="email" id="emailaddress" required placeholder="Enter your city/town">
                            </div>
                            <div class="mb-3">
                                <label for="emailaddress" class="form-label">Province</label>
                                <input class="form-control" type="email" id="emailaddress" required placeholder="Enter your province">
                            </div>
                            <div class="mb-3">
                                <label for="emailaddress" class="form-label">Postal Code</label>
                                <input class="form-control" type="email" id="emailaddress" required placeholder="Enter your postal code">
                            </div>
                            <div class="mb-3">
                                <label for="emailaddress" class="form-label">Country</label>
                                <input class="form-control" type="email" id="emailaddress" required placeholder="Enter your country">
                            </div>
                            <div class="mb-3">
