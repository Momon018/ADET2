<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        if ($pass == $pass2)
        {
            ...
            $sql = "INSERT INTO `customer` (`CustomerID`, `First_name`, `Middle_name`, `Last_name`, `Suffix_name`, `Customer_email`, `Password`, `Gender`, `Birthdate`, `Contact_number`, `Line1_add`, `Line2_add`, `City/Town`, `Barangay`, `Province`, `Country`, `PostalCode`, `Created_by`, `User_type`, `Status`) VALUES ('$uuid','$fname','$mname','$lname','$sname','$email','$phash','$gender','$bday','$contact','$line1','$line2','$city','$barangay','$province','$country','$postal','$uuid','Borrower','Active')";
            ...
            <div class="auth-fluid-form-box">
                <div class="align-items-center d-flex h-100">
                    <div class="card-body">
                        ...
                        <!-- title-->
                        <h4 class="mt-0">Borrower Sign Up</h4>
